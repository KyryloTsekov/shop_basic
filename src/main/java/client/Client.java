    ...
    public static void productOperations() throws ProductSaveException, ProductNotFoundException, ProductUpdateException {
        ...
        switch (choice) {
            ...
            case 9:
                ...
                break;
            case 10:
                System.out.println("Средняя стоимость продуктов - " + productController.getActiveProductsAveragePrice());
                break;
            case 0:
                return;
            default:
        ...
        while (true) {
            ...
            switch (choice) {
                ...
                case 10:
                    System.out.println("Введите идентификатор покупателя:");
                    id = Long.parseLong(scanner.nextLine());
                    System.out.println("Средняя стоимсоть продуктов в корзине - " + customerController.getCustomersCartAveragePrice(id));
                    break;
                case 11:
                    System.out.println("Введите идентификатор покупателя:");
