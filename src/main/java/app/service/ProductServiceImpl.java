...
public class ProductServiceImpl implements ProductService {
    ...
    // Объект продукта не должен быть null
    // При сохранении контролируем название -
    // оно должно быть не пустым и содержать хотя бы 3 символа
    // Также контролируем цену - она должна быть больше нуля.
    // Также мы должны делать продукт активным при его сохранении.
    @Override
    ...
    public void updateActiveProduct(Product product) throws ProductUpdateException, ProductNotFoundException {
        ...
        repository.update(existedProduct);
    }
